...
function F(o) {
  ...
  if (e != null && e.hasAttribute("href")) {
    ...
    if ((o.preventDefault(), r != null && r.startsWith("#"))) return k(r), { type: "scrolled" };
    const s = (t = r.match(/#([\w'-]+)\b/g)) == null ? void 0 : t[0],
      i = u(n.href),
      c = u();
...
function A(o) {
  const e = (i) => Array.from(i.querySelectorAll('head>:not([rel="prefetch"]')),
    t = e(document),
    r = e(o),
    { staleNodes: n, freshNodes: s } = L(t, r);
...
class q {
    ...
    (this.opts = e),
      ...
      window != null && window.history
        ? (document.addEventListener("click", (t) => this.onClick(t)),
          ...
          this.prefetch())
        : (console.warn("flamethrower router not supported in this browser or environment"), (this.enabled = !1));
  }
  go(e) {
  ...
  async reconstructDOM({ type: e, next: t, prev: r, scrollId: n }) {
    ...
    try {
      ...
      return (
        window.dispatchEvent(new CustomEvent("flamethrower:router:error", s)),
        this.opts.log && console.timeEnd("\u23F1\uFE0F"),
